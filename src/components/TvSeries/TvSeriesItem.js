...
export default function TvSeriesItem({ item, onClick }) {
  ...
  return (
    <div onClick={onClick} className="tvseries__item">
      <div className="tvseries__picture">
        <img
          src={item.thumbnail.regular.small}
          alt={item.title}
          className="tvseries__picture-img"
        />
        <div
      ...
      <div className="tvseries__section">
        <div className="tvseries__details">
          ...
          <div className="tvseries__detail">
            {item.category === "Movie" ? (
              <MovieIcon className="tvseries__detail-icon" />
            ) : (
              <TvIcon className="tvseries__detail-icon" />
            )}
