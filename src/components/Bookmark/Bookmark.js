    ...
    <div className="bookmark">
      <div className="bookmark-movie">
        ...
        <div className="bookmark-movie__content">
          {filteredBookmarkMovies.length === 0 ? (
            <div className="bookmark-movie__empty">
              <FontAwesomeIcon
                className="bookmark-movie__empty-icon"
                icon={faFolderOpen}
              />
              Movie list is empty
            </div>
      ...
      <div className="bookmark-tvseries">
        ...
        <div className="bookmark-tvseries__content">
          {filteredBookmarkTvseries.length === 0 ? (
            <div className="bookmark-tvseries__empty">
              <FontAwesomeIcon
                className="bookmark-tvseries__empty-icon"
                icon={faFolderOpen}
              />
