    ...
    >
      <div className="bookmark-tvseries__picture">
        ...
        <div
          ...
          className="bookmark-tvseries__picture-icon"
        >
          <BookmarkFull />
        </div>
      ...
      <div className="bookmark-tvseries__section">
        <div className="bookmark-tvseries__details">
          ...
          <div className="bookmark-tvseries__detail">
            {item.category === "Movie" ? (
              <MovieIcon className="bookmark-tvseries__detail-icon" />
            ) : (
              <TvIcon className="bookmark-tvseries__detail-icon" />
            )}
            <div className="bookmark-tvseries__detail-category">
              {item.category}
            </div>
          </div>
