      ...
      <div className="trending">
        ...
        >
          {trendingItems.map((item) => (
            <SwiperSlide onClick={() => handleCurrentItem(item)} key={item.id}>
                ...
                <div className="trending__section">
                  <div className="trending__elements">
                    ...
                    <div className="trending__element">
                      {item.category === "Movie" ? (
                        <MovieIcon className="trending__element-icon trending__element-icon--tv" />
                      ) : (
                        <TvIcon className="trending__element-icon" />
                      )}
                      <div className="trending__element-category">
                        {item.category}
                      </div>
                    </div>
                    <div className="trending__element-rating">
                      {item.rating}
                    </div>
                  </div>
