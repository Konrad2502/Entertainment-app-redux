...
export default function HomeItem({ item, onClick }) {
  ...
  return (
    <div onClick={onClick} className="recommended__item">
      <div className="recommended__picture">
        <img
          src={item.thumbnail.regular.small}
          alt={item.title}
          className="recommended__picture-img"
        />
        <div
      ...
      <div className="recommended__section">
        <div className="recommended__details">
          ...
          <div className="recommended__detail">
            {item.category === "Movie" ? (
              <MovieIcon className="recommended__detail-icon" />
            ) : (
              <TvIcon className="recommended__detail-icon" />
            )}
