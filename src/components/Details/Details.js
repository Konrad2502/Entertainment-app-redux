...
export default function Details({setIsItemVisible, isItemVisible}) {
  ...
  return item ? (
    <div className={`details__leyer ${isItemVisible ? "details__leyer--visible" : ""}`}>
    <div className="details">
        <div className="details__img">
            <img className="details__img-picture" src={item.thumbnail.regular.large} alt={item.title} />
        </div>
